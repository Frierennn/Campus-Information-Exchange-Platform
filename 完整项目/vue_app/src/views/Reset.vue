<template>
  <el-container class="cennter" style="align-items: center; height: 100%">
    ...
    >
      <div style="width: 100%">
        <el-divider><h1>重置密码</h1></el-divider>
      </div>
      <el-form
        :model="param"
        :rules="rules"
      ...
      <div style="width: 100%; text-align: center">
        <router-link to="/Login">⇛ 无须重置，点此返回</router-link>
      </div>
      <br />
      <div style="width: 100%; text-align: center" v-show="hide">
        <router-link to="/Register">⇛ 尚未注册，点此注册</router-link>
      </div>
      <br />
      <div style="width: 100%; text-align: center">
        重置即代表你同意用户协议和隐私政策
